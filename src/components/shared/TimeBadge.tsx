...
const MAP: Record<Time, { label: string; className: string }> = {
  ...
  'alta-renda': { label: 'Alta Renda', className: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400' },
  'varejo': { label: 'Varejo', className: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400' },
  'on-demand': { label: 'On Demand', className: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400' },
  'performance': { label: 'Performance', className: 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-400' },
}
